...
const TRANSLATIONS: Record<Language, Translations> = {
  en: {
    ...
    'settings.back': 'Back',
    'settings.lcdDisplay': 'LCD Display',
    'settings.lcdScrollSpeed': 'Scroll Speed',
    'settings.scrollSpeedSlow': 'Slow',
    'settings.scrollSpeedMedium': 'Medium',
    'settings.scrollSpeedFast': 'Fast',
    'settings.lcdColorTheme': 'Color Theme',
    'settings.colorThemeGreen': 'Green',
    'settings.colorThemeAmber': 'Amber',
    'settings.colorThemeBlue': 'Blue',
    ...
    'deviceDetails.bluetoothPairingInProgress': 'Starting Bluetooth pairing…',
    'deviceDetails.bluetoothStartPairing': 'Start Bluetooth pairing',
    'controlPanel.title': 'Control Panel',
    'controlPanel.togglePower': 'Toggle power',
    'controlPanel.previousTrack': 'Previous track',
    'controlPanel.playPause': 'Play or pause',
    'controlPanel.nextTrack': 'Next track',
    'controlPanel.volumeDown': 'Volume down',
    'controlPanel.volumeUp': 'Volume up',
    'controlPanel.switchAux': 'Switch to AUX',
    'controlPanel.nowPlaying': 'Now Playing',
    'controlPanel.noPlayback': 'No playback information',
    'presets.title': 'Presets',
    'presets.play': 'Play',
    'presets.edit': 'Edit',
    'presets.addNew': 'Add Preset',
    'presets.settings': 'Settings',
    'presets.backToPlayMode': 'Back',
  ...
  pl: {
    ...
    'settings.lcdDisplay': 'Wyświetlacz LCD',
    'settings.lcdScrollSpeed': 'Prędkość przewijania',
    'settings.scrollSpeedSlow': 'Wolna',
    'settings.scrollSpeedMedium': 'Średnia',
    'settings.scrollSpeedFast': 'Szybka',
    'settings.lcdColorTheme': 'Motyw kolorystyczny',
    'settings.colorThemeGreen': 'Zielony',
    'settings.colorThemeAmber': 'Bursztynowy',
    'settings.colorThemeBlue': 'Niebieski',
    ...
    'deviceDetails.bluetoothPairingInProgress': 'Rozpoczynanie parowania Bluetooth…',
    'deviceDetails.bluetoothStartPairing': 'Rozpocznij parowanie Bluetooth',
    'controlPanel.title': 'Panel sterowania',
    'controlPanel.togglePower': 'Przełącz zasilanie',
    'controlPanel.previousTrack': 'Poprzedni utwór',
    'controlPanel.playPause': 'Odtwórz lub wstrzymaj',
    'controlPanel.nextTrack': 'Następny utwór',
    'controlPanel.volumeDown': 'Ścisz',
    'controlPanel.volumeUp': 'Zwiększ głośność',
    'controlPanel.switchAux': 'Przełącz na AUX',
    'controlPanel.nowPlaying': 'Teraz odtwarzane',
    'controlPanel.noPlayback': 'Brak informacji o odtwarzaniu',
    'presets.title': 'Presety',
    'presets.play': 'Odtwórz',
    'presets.edit': 'Edytuj',
    'presets.addNew': 'Dodaj preset',
    'presets.settings': 'Ustawienia',
    'presets.backToPlayMode': 'Powrót',
