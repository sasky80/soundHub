...
describe('DeviceConfigComponent', () => {
  ...
  it('should load network mask on init', () => {
    fixture.detectChanges();
    flushInitialRequests();
  ...
  it('should ping device and update state', () => {
    fixture.detectChanges();
    flushInitialRequests();
  ...
  it('should show ping button only for devices with ping capability', () => {
    fixture.detectChanges();
    flushInitialRequests();
  ...
  it('should highlight newly added devices', () => {
    fixture.detectChanges();
    flushInitialRequests();
  ...
  it('should discover devices and reload on success', () => {
    fixture.detectChanges();
    flushInitialRequests();
  ...
  it('should open add device form', () => {
    fixture.detectChanges();
    flushInitialRequests();
  ...
  it('should open edit device form with device data', () => {
    fixture.detectChanges();
    flushInitialRequests();
  ...
  it('should toggle capability selection', () => {
    fixture.detectChanges();
    flushInitialRequests();
